var app = new Vue({
    ...
    data: {
        ...
        cmdVelTopic: null,
        navGoalTopic: null,
        cmdVelTopicName: '/fastbot/cmd_vel',
    ...
    methods: {
        ...
        setCamera() {
            ...
            new MJPEGCANVAS.Viewer({
                ...
                topic: '/fastbot/camera/image_raw', ssl: true,
            });
        },
        ...
        setup3DViewer() {
            this.viewer = new ROS3D.Viewer({
                ...
                antialias: true, fixedFrame: 'fastbot/odom'
            });
            this.viewer.addObject(new ROS3D.Grid({ color: '#0181c4', cellSize: 0.5, num_cells: 20 }));
            this.tfClient = new ROSLIB.TFClient({
                ros: this.ros, angularThres: 0.01, transThres: 0.01, rate: 10.0, fixedFrame: 'fastbot_base_link'
            });
            this.urdfClient = new ROS3D.UrdfClient({
                ros: this.ros, param: '/fastbot_robot_state_publisher:robot_description',
        ...
        setupROSCommunication() {
            ...
            this.twistSub = new ROSLIB.Topic({
                ros: this.ros, name: '/fastbot/cmd_vel', messageType: 'geometry_msgs/msg/Twist'
            });
            ...
            this.odomSub = new ROSLIB.Topic({
                ros: this.ros, name: '/fastbot/odom', messageType: 'nav_msgs/msg/Odometry'
            });
        ...
        autoDetectCmdVelTopic() {
            return new Promise((resolve) => {
                this.ros.getTopics((res) => {
                    ...
                    const prefer = [
                        '/fastbot/cmd_vel_smoothed', '/cmd_vel_smoothed', '/fastbot/cmd_vel', '/cmd_vel', '/nav2_controller/cmd_vel'
                    ];
